...
Invoke-SigmaPotato -command "e:\fin\anyd.exe --install e:\aaa --start-with-win --silent"
Invoke-SigmaPotato -command "cmd /c echo Sqopis@123 | e:\aaa\anydesk.exe --set-password"